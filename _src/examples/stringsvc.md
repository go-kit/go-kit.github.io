...
Our first example [stringsvc1](https://github.com/go-kit/examples/tree/master/stringsvc1) had all of these layers in a single main file.
...
See [addsvc/cmd/addcli](https://github.com/go-kit/examples/tree/master/addsvc/cmd/addcli)
 or [package profilesvc/client](https://github.com/go-kit/examples/tree/master/profilesvc/client)
 for examples.
